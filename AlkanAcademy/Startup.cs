...
using AlkanAcademy.Service.Base;
...
namespace AlkanAcademy
{
    public class Startup
    {
        ...
        {
           services.AddMvc();
            services.AddDbContext<AlkanAcademyContext>(options => options.UseSqlServer("Server=LAPTOP-NUB224AS;Database=AlkanAcademy;Trusted_Connection=True;"));
